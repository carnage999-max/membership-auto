...
import { Wrench, Leaf, Star, User, Gem, Handshake, Zap } from "lucide-react";

export default function WhyUsPage() {
  const certifications = [
    { name: "ASE Certified", icon: <Wrench className="w-16 h-16 text-[var(--gold)] mx-auto" /> },
    { name: "EPA Compliant", icon: <Leaf className="w-16 h-16 text-[var(--gold)] mx-auto" /> },
    { name: "BBB A+", icon: <Star className="w-16 h-16 text-[var(--gold)] mx-auto" /> },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="w-64 h-64 bg-[var(--surface)] border border-[var(--gold)] rounded-full mx-auto md:mx-0 flex items-center justify-center shadow-xl shadow-black/60">
                  <User className="w-32 h-32 text-[var(--gold)]" />
                </div>
              </div>
              <div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-[var(--surface)] rounded-lg p-8 shadow-sm border border-[var(--border-color)]">
                <Gem className="w-12 h-12 text-[var(--gold)] mb-4" />
              ...
              <div className="bg-[var(--surface)] rounded-lg p-8 shadow-sm border border-[var(--border-color)]">
                <Handshake className="w-12 h-12 text-[var(--gold)] mb-4" />
                <h3 className="text-xl font-semibold text-[var(--foreground)] mb-3">
                  Honesty
                </h3>
                <p className="text-[var(--text-secondary)]">
