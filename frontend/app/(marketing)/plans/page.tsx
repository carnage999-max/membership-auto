...
export default function PlansPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      {/* Header */}
      <section className="bg-[var(--surface)] py-20 border-b border-[var(--border-color)]">
              ...
              >
                ...
                <Link
                  ...
                  className={`block w-full text-center py-3 px-6 rounded-full font-semibold transition-all duration-200 ${
                    index === 2
                      ? "bg-[var(--gold)] text-[var(--background)] hover:bg-[#d8b87f] shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {covered.map((item, i) => (
                ...
                >
                  <CheckCircle className="w-5 h-5 text-[var(--gold)] mr-3" />
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {notCovered.map((item, i) => (
                <div
                  ...
                  className="flex items-center p-4 bg-[var(--surface)] rounded-lg border border-[var(--border-color)]"
                >
                  <XCircle className="w-5 h-5 text-[var(--error)] mr-3" />
                  <span className="font-medium text-[var(--foreground)]">
                    {item}
                  </span>
                </div>
