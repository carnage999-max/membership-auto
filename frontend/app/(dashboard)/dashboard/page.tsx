        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-[var(--error)] text-white rounded-full hover:bg-[#f06561] transition-colors">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-gradient-to-br from-[#cba86e] to-[#e0bf7f] rounded-lg p-8 text-[#0d0d0d] shadow-lg">
                <div className="flex items-center justify-between">
                  ...
                  <Wallet className="w-16 h-16 text-[#0d0d0d] opacity-75" />
                </div>
              </div>
              ...
              <div className="bg-[var(--surface)] rounded-lg shadow-lg p-6 border border-[var(--border-color)]">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button className="flex items-center gap-2 px-4 py-2 bg-[var(--gold)] text-[#0d0d0d] rounded-full hover:bg-[#d8b87f] text-sm transition-colors">
                ...
                {vehicles.map((vehicle) => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <button className="flex items-center gap-2 text-[var(--gold)] hover:text-[#d8b87f] font-semibold">
              ...
              <div className="bg-[var(--surface)] rounded-lg shadow-lg p-6 border border-[var(--border-color)]">
                ...
                <Link
                  href="/appointments"
                  className="mt-4 inline-flex items-center gap-2 text-[var(--gold)] hover:text-[#d8b87f] font-semibold"
                >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[var(--surface)] rounded-lg shadow-lg p-6 border border-[var(--border-color)]">
                ...
                <div className="space-y-3">
                  <button className="w-full px-4 py-3 bg-[var(--gold)] text-[#0d0d0d] rounded-lg hover:bg-[#d8b87f] font-semibold text-left transition-colors flex items-center gap-3">
                    <Wrench className="w-5 h-5" />
                    Request a Repair
                  </button>
                  <button className="w-full px-4 py-3 bg-[#111111] text-[var(--foreground)] rounded-lg hover:bg-[#1a1a1a] font-semibold text-left border border-[var(--border-color)] transition-colors flex items-center gap-3">
                  ...
                  <Link
                    href="/chat"
                    className="block w-full px-4 py-3 bg-[#111111] text-[var(--foreground)] rounded-lg hover:bg-[#1a1a1a] font-semibold text-left border border-[var(--border-color)] transition-colors flex items-center gap-3"
                  >
              ...
              <div className="bg-[var(--surface)] rounded-lg shadow-lg p-6 border border-[var(--border-color)]">
                ...
                <div className="space-y-3">
                  <Link
                    href="/help"
                    className="flex items-center gap-2 text-[var(--gold)] hover:text-[#d8b87f] font-semibold"
                  >
